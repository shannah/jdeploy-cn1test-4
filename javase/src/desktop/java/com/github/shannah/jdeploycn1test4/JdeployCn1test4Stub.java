...
package com.github.shannah.jdeploycn1test4;
 ...
 * @author Shai Almog
 */
public class JdeployCn1test4Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Jdeploy Cn1test 4";
    private static final String APP_NAME = "jdeploy-cn1test-4";
    ...
    private JdeployCn1test4 mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new JdeployCn1test4Stub());
    }
